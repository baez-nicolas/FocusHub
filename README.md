...
- Estados:  Planificado, Completado, Omitido
...
- **Deploy:** Vercel
- **Estilos:** CSS3 + Bootstrap utilities
...
- **LocalStorage:** Persistencia client-side con wrapper de servicio
